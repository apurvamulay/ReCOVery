...
def test(x_test_head, x_test_image,  y_test, model):
...
if __name__ == '__main__':
    ...
    index = np.where(y_single_test == 0)
    x_head_test = x_head_test[index]
    x_image_test = x_image_test[index]
    y_test = y_test[index]
    ...
    with open('~/safe/prediction_result_notrel.json', 'w') as f:
        json.dump(dic_all, f)